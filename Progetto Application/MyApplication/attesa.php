...
<body>
    ...
    if (isset($_SESSION['email'])) {
        ...
        if (isset($_POST['id'])) {
            ...
            insertPrenotazioneAttesa($pr, $user, $titolo, $luogo, $descrizione, $timeStart, $timeEnd, $idDisciplina, $data, $societa);
        }
            $ret = esecuzionePropostaAttesa($user); ?>
            ...
            <div class="container_tracks">
                ...
                <div class="container_tracks_tracks">
                    <div class="tracks_tracks_subTitle"><em>In attesa di conferma</em></div>
                        ...
                        while ($row = pg_fetch_array($ret)) {
                            ...
                            <div class = 'elemtImg'><img src=\"Img/$img\"></div>
                                     ...
                                     <form action='invita.php' method='post'>
                                        ...
                                        <input type='hidden' name='attesaGruppo' value = 'attesa'>        
                                    ...
                                    <form action='invitaUtente.php' method='post'>
                                        ...
                                        <input type='hidden' name='codiceEvento' value='$codiceEvento'>
                                        <input type='hidden' name='costo' value='$costo'>    
                                        <input type='hidden' name='attesaUtente'>    
